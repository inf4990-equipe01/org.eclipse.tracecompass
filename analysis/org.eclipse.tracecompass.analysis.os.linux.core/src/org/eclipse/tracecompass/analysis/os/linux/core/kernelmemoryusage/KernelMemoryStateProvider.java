...
public class KernelMemoryStateProvider extends AbstractTmfStateProvider {
    ...
    protected void eventHandle(@NonNull ITmfEvent event) {
        ...
        try {
            ...
            // SAMUEL : I am adding a whole attribute for each thread to keep the lowest memory value
            // for that thread. We then use this quantity when we plot the memory usage to avoid
            // negative values (we shift everything up). However, I don't find this solution very
